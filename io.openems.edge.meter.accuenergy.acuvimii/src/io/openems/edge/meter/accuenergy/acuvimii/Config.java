...
@ObjectClassDefinition(//
		name = "Accuenergy Acuvim II", //
		description = "Implements the Accuenergy Acuvim II meter")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Accuenergy Acuvim II [{id}]";
